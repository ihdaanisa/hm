...
<div class="container mt-5">
    ...
    <!-- Preview Image -->
    <img id="profile-picture-preview" src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('images/default-profile.png') }}" alt="Profile Picture Preview" class="mt-3" style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;">
</div>
